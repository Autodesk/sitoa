...
AI_SHADER_NODE_EXPORT_METHODS(MapLookupColorMethods);

enum MapLookupColorParams 
{
   p_map,
   p_factor,
};
...
shader_evaluate
{
   ...
   // clamp the alpha, else artifacts show up (#1070)
